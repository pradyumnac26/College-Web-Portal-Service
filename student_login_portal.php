...
<body>
  <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
      if (($h = fopen("validation_creds_student.csv", "r")) !== FALSE) 
      {
  ...
  ?>
    ...
    <div class="navbar">        
        ...
        <a class="active" href="student_login_portal.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Student</a>
    ...
    <div id="id01" >
        ...
        <form class="modal-content animate" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
          ...
          <div class="container" style="padding-bottom: 14px;">
            ...
            <input type="text" placeholder="Enter USN" name="uname" required>
